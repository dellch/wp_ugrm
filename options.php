  ...
  <h2><?php _e('A&W Productions UFAD to Wordpress Roles Munger Options', 'UGRM_header'); ?></h2>
   ...
   <table class="form-table">
     <tr valign="top">
       ...
       <td><input type="text" style="width:280px;" name="UGRM_admin_role" value="<?php echo get_option('UGRM_admin_role'); ?>"/></td>
    </tr>
    
     <tr valign="top">
       <th scope="row">UFAD Group for Editor Role</th>
       <td><input type="text" style="width:280px;" name="UGRM_editor_role" value="<?php echo get_option('UGRM_editor_role'); ?>"/></td>
    </tr>
    
     <tr valign="top">
       <th scope="row">UFAD Group for Author Role</th>
       <td><input type="text" style="width:280px;" name="UGRM_author_role" value="<?php echo get_option('UGRM_author_role'); ?>"/></td>
    </tr>    
    
     <tr valign="top">
       <th scope="row">UFAD Group for Contributor Role</th>
       <td><input type="text" style="width:280px;" name="UGRM_contributor_role" value="<?php echo get_option('UGRM_contributor_role'); ?>"/></td>
    </tr>    
    
     <tr valign="top">
       <th scope="row">UFAD Group for Subscriber Role</th>
       <td><input type="text" style="width:280px;" name="UGRM_subscriber_role" value="<?php echo get_option('UGRM_subscriber_role'); ?>"/></td>
    </tr>
